    ...
    <div class="container mx-auto px-4 py-6">
      <div class="flex flex-col md:flex-row justify-between">
        <div class="mb-4 md:mb-0">
          <h2 class="text-xl font-bold mb-2">FreeNetly</h2>
          <p class="text-gray-400 text-sm">Free online tools for everyone</p>
        </div>
        ...
        <div class="grid grid-cols-2 gap-8 sm:grid-cols-3">
          ...
          <div>
            <h3 class="text-sm font-semibold mb-2 text-gray-300">Legal</h3>
            <ul class="space-y-1">
